    ...
    <div class="row">
      <div class="col-md-12">
        <div class="card">
          ...
          <form method="post" action="{{url('admin/expense/category/insert')}}">
            @csrf
          <div class="card-body">
              <div class="form-group row">
                <label for="" class="col-sm-3 col-form-label">Expense Category Name <span class="text-danger">*</span></label>
                <div class="col-sm-8">
